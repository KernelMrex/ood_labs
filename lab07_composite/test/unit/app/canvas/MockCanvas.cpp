...
{
public:
	MOCK_METHOD(void, DrawLine, (const SPoint& from, const SPoint& to, const SColor& color, uint thickness), (override));
	MOCK_METHOD(void, FillPolygon, (const std::vector<SPoint>& vertices, const SColor& color), (override));
